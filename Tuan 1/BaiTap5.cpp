...
void SetDiem(ToaDo &X, double HoanhDo = 0, double TungDo = 0)
{
    X.HoanhDo = HoanhDo;
    X.TungDo = TungDo;
}
...
int main()
{
    ...
    for (int i = 0; i < SoPhanTu; i++)
    {
        ...
        if (i % 3 == 0)
        {
            ...
            cin >> HoanhDo >> TungDo;
            SetDiem(Mang[i], HoanhDo, TungDo);
        }
        else if (i % 3 == 1)
        {
            cout << "Chi nhap Hoanh Do: ";
            cin >> HoanhDo;
            SetDiem(Mang[i], HoanhDo);
        }
        else if (i % 3 == 2)
        {
            cout << "Hoanh Do bang 0 va Tung Do bang 0" << endl;
            SetDiem(Mang[i]);
        }
    }
    ...
    {
        cout << "Diem thu " << i << " la: ";
        cout << "(" << Mang[i].HoanhDo << ";" << Mang[i].TungDo << ")" << endl;
    }
    int DiemThuNhat = 0;
    int DiemThuHai = 1;
